...
class SampleEmbedding(nn.Module):
    def __init__(self, c_in=4, d_model=288, seq_len=2114, seq_len_up_bound=2114):
...
class BottleneckLayer(nn.Module):
    def __init__(self, seq_len, d_models=288):
        ...
        self.feature_map = {600: 432, 1000: 720, 1344: 1008, 2114: 1584, 131072: 720}
...
class Protrait(nn.Module):
    def __init__(self, seq_len=2114, seq_len_up_bound=2114,
                 c_in=4, d_model=288, n_heads=8, n_cells=19):
